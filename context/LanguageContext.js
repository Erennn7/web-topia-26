...
const translations = {
  en: {
    lang: "English",
    nav: { home: "Home", services: "Services", resources: "Resources", findHelp: "Find Help", emergency: "Emergency", about: "About", contact: "Contact", schemes: "Schemes", medicine: "Medicine", digitalLearning: "Learn", hospitals: "Hospitals" },
    ...
    categories: { healthcare: "Healthcare", meals: "Meals", transport: "Transport", legal: "Legal Aid", financial: "Financial", companion: "Companion", schemes: "Gov Schemes", medicine: "Medicine", hospitals: "Hospitals" },
    ...
    emergency: { title: "Emergency", subtitle: "Call 112 for immediate danger", call911: "Call 112 Now", contacts: "Emergency Contacts", safety: "Safety Tips", sos: "SOS — Get Help", nonEmergency: "Non-Emergency Help?" },
    ...
    nearbyHospitals: { title: "Nearby Hospitals", subtitle: "Find hospitals, clinics, and medical facilities near your current location.", back: "Back", fullscreen: "Fullscreen", openNew: "Open in New Tab", featureLocate: "Auto-Detect Location", featureLocateDesc: "Uses your GPS to find nearby facilities", featureDirections: "Get Directions", featureDirectionsDesc: "Navigate directly from the map", featureDetails: "Hospital Details", featureDetailsDesc: "View contact info, ratings, and services", live: "Live Map", expand: "Expand" },
  ...
  hi: {
    lang: "हिन्दी",
    nav: { home: "होम", services: "सेवाएं", resources: "संसाधन", findHelp: "मदद खोजें", emergency: "आपातकाल", about: "हमारे बारे में", contact: "संपर्क", schemes: "योजनाएं", medicine: "दवाई", digitalLearning: "सीखें", hospitals: "अस्पताल" },
    ...
    categories: { healthcare: "स्वास्थ्य", meals: "भोजन", transport: "परिवहन", legal: "कानूनी सहायता", financial: "वित्तीय", companion: "साथी सेवा", schemes: "सरकारी योजना", medicine: "दवाई", hospitals: "अस्पताल" },
    ...
    emergency: { title: "आपातकाल", subtitle: "तुरंत खतरे के लिए 112 पर कॉल करें। एम्बुलेंस: 108", call911: "112 पर कॉल करें", contacts: "आपातकालीन नंबर", safety: "सुरक्षा सुझाव", sos: "SOS — मदद पाएं", nonEmergency: "गैर-आपातकालीन मदद?" },
    ...
    nearbyHospitals: { title: "नजदीकी अस्पताल", subtitle: "अपने वर्तमान स्थान के पास अस्पताल, क्लीनिक और चिकित्सा सुविधाएं खोजें।", back: "वापस", fullscreen: "पूर्ण स्क्रीन", openNew: "नई टैब में खोलें", featureLocate: "स्वत: स्थान पता लगाएं", featureLocateDesc: "आस-पास की सुविधाओं के लिए GPS का उपयोग करें", featureDirections: "दिशा-निर्देश पाएं", featureDirectionsDesc: "मानचित्र से सीधे नेविगेट करें", featureDetails: "अस्पताल विवरण", featureDetailsDesc: "संपर्क जानकारी, रेटिंग और सेवाएं देखें", live: "लाइव मैप", expand: "विस्तार करें" },
  ...
  mr: {
    lang: "मराठी",
    nav: { home: "मुख्यपृष्ठ", services: "सेवा", resources: "संसाधने", findHelp: "मदत शोधा", emergency: "आणीबाणी", about: "आमच्याबद्दल", contact: "संपर्क", schemes: "योजना", medicine: "औषध", digitalLearning: "शिका", hospitals: "रुग्णालय" },
    ...
    categories: { healthcare: "आरोग्य", meals: "जेवण", transport: "वाहतूक", legal: "कायदेशीर मदत", financial: "आर्थिक", companion: "सोबती सेवा", schemes: "सरकारी योजना", medicine: "औषध", hospitals: "रुग्णालय" },
    ...
    emergency: { title: "आणीबाणी", subtitle: "तात्काळ धोक्यासाठी 112 वर कॉल करा. रुग्णवाहिका: 108", call911: "112 वर कॉल करा", contacts: "आणीबाणी क्रमांक", safety: "सुरक्षा टिप्स", sos: "SOS — मदत मिळवा", nonEmergency: "बिगर-आणीबाणी मदत?" },
    ...
    nearbyHospitals: { title: "जवळची रुग्णालये", subtitle: "तुमच्या सध्याच्या ठिकाणाजवळ रुग्णालये, दवाखाने आणि वैद्यकीय सुविधा शोधा.", back: "मागे", fullscreen: "पूर्ण स्क्रीन", openNew: "नवीन टॅबमध्ये उघडा", featureLocate: "स्वयं-स्थान शोधा", featureLocateDesc: "जवळच्या सुविधांसाठी GPS वापरा", featureDirections: "दिशानिर्देश मिळवा", featureDirectionsDesc: "नकाशावरून थेट नेव्हिगेट करा", featureDetails: "रुग्णालय तपशील", featureDetailsDesc: "संपर्क माहिती, रेटिंग आणि सेवा पहा", live: "लाइव्ह नकाशा", expand: "विस्तार करा" },
